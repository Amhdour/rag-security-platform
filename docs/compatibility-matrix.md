...
| Runtime Plane | Governance Plane | Adapter Plane | Onyx Remote | Onyx Ref | Onyx Commit | Secure Starter Kit Remote | Secure Starter Kit Ref | Secure Starter Kit Commit | Adapter Commit Basis | Provenance Lock Status | Status | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
3. **Current unconfirmed compatibility**
   ...
   - **Unconfirmed:** Secure Starter Kit canonical upstream remote/ref/commit cannot be verified without nested git metadata.
